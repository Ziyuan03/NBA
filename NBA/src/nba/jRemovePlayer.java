...
public class jRemovePlayer extends javax.swing.JFrame {
    ...
    private void setImage() {
        setLabelImageMethod("C:\\Users\\Ziyua\\OneDrive\\Documents\\NetBeansProjects\\NBA_GManager\\NBA\\NBA\\src\\icons\\removePlayer2.png", icon);
    ...
    public void displayTable(String variable, String text) {
        try {
            PreparedStatement pstmt = con.prepareStatement("SELECT * FROM SAN_ANTONIO WHERE " + variable);
    ...
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
        ...
        if (selectedRow == -1) {
            ...
            jap.setImageMethod("C:\\Users\\user\\OneDrive\\Documents\\NetBeansProjects\\NBA_MAIN\\src\\icons\\iconPlayerProfile\\iconInjury.png", jap.getIconInjury());
